...
const Header = () => {
  ...
  return (
    <div className="flex flex-col sticky top-0 space-y-2 sm:flex-row sm:space-y-0 justify-evenly items-center header h-36">
      ...
      <div className="font-bold text-3xl space-x-2 sm:order-1">
