...
const InformationArtist = () => {
    ...
    return (
        <>
            ...
            <div style={{ direction: "rtl" }} className="text-white mt-10 space-y-4 px-10 md:px-32" dangerouslySetInnerHTML={{
                __html: sanitizeHtml(html),
            }}>
            </div>
            <p className="font bold text-3xl text-center text-yellow-500 mt-10">آهنگ های {name}</p>
            <div className="grid mt-10 px-5 gap-5 grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                {
